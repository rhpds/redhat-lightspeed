...
**Owner:** JBSpinks
**Migrated from:** https://github.com/rhpds/zt-lb1187-hands-on-with-lightspeed-in-satellite
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/redhat-lightspeed`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/redhat-lightspeed
   ```
3. `cd redhat-lightspeed`
